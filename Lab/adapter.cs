...
public class PaymentAdapterA : IPaymentProcessor
{
    ...
    public PaymentAdapterA(ExternalPaymentSystemA externalSystemA) => _externalSystemA = externalSystemA;
...
public class PaymentAdapterB : IPaymentProcessor
{
    ...
    public PaymentAdapterB(ExternalPaymentSystemB externalSystemB) => _externalSystemB = externalSystemB;
...
public class PaymentProcessorFactory
{
    public static IPaymentProcessor GetPaymentProcessor(string systemType)
    {
        return systemType switch
        {
            ...
            _ => throw new ArgumentException("Invalid payment system type.")
        };
    }
}
